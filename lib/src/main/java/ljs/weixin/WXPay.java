...
//        }
     ...
     * @throws Exception
     */
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws KnowException {
     ...
     * @throws Exception
     */
    public boolean isResponseSignatureValid(Map<String, String> reqData) throws KnowException {
    ...
    public String requestWithCert(String urlSuffix, Map<String, String> reqData,
                                  int connectTimeoutMs, int readTimeoutMs) throws KnowException {
        String msgUUID = reqData.get("nonce_str");
        String reqBody = WXPayUtil.mapToXml(reqData);
     ...
     * @throws Exception
     */
    public Map<String, String> processResponseXml(String xmlStr) throws KnowException {
        ...
        if (respData.containsKey(RETURN_CODE)) {
            ...
            throw new KnowException(String.format("No `return_code` in XML: %s", xmlStr));
        }
        ...
        if (return_code.equals(WXPayConstants.FAIL)) {
            ...
            if (this.isResponseSignatureValid(respData)) {
                ...
                throw new KnowException(String.format("Invalid sign value in XML: %s", xmlStr));
            }
        } else {
            throw new KnowException(String.format("return_code value %s is invalid in XML: %s", return_code, xmlStr));
        }
    }
    ...
    public String getSignType() {
        String signType = WxConstants.MD5;
        if (this.signType == WXPayConstants.SignType.HMACSHA256)
            signType = WxConstants.SHA256;
        return signType;
    }
     ...
     * @throws Exception
     */
    public Map<String, String> refund(Map<String, String> reqData) throws KnowException {
     ...
     * @throws Exception
     */
    public Map<String, String> refund(Map<String, String> reqData, int connectTimeoutMs, int readTimeoutMs) throws KnowException {
        String url;
        if (this.useSandbox) {
