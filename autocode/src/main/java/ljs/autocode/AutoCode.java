...
public class AutoCode {
    public static Logger logger = Logger.getLogger(AutoCode.class.getSimpleName());

    public static HashMap<Object, Object> getModal(Config config) {
    ...
    public static void write(Object model, String view, File out) throws Exception {
        if (out.exists())
            throw new RuntimeException(out.getCanonicalPath() + "已存在,为保护你的文件,中断操作");
        if (!out.getParentFile().exists())
            out.getParentFile().mkdirs();
        Configuration cfg = new Configuration(Configuration.VERSION_2_3_25);
        cfg.setClassForTemplateLoading(AutoCode.class, "/");
        ...
        logger.info("输出:" + out.getCanonicalPath());
    }
    ...
    public static void run(String dbName, String host, String user, String passWord, String domain) throws Exception {
        run(dbName, host, user, passWord, domain + ".base.BasePojo", domain + ".pojo", domain + ".mapper", domain + ".service", domain + ".controller");
    }

    public static void run(String dbName, String host, String user, String password, String supperPojoClassName, String pojoPackage, String mapperPackage, String servicePackage, String controllerPackage) throws Exception {
        ...
        for (Table table : dataBase.tables) {
            ...
            HashMap<Object, Object> model = getModal(config);
