...
public class WXPayRequest {
    ...
    private String request(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean useCert, boolean autoReport) throws KnowException {
        Exception exception;
        ...
        if (domainInfo == null) {
            throw new KnowException("WXPayConfig.getWXPayDomain().getDomain() is empty or null");
        }
        try {
        ...
        throw new KnowException(exception.getMessage());
    }
     ...
     * @return
     */
    public String requestWithCert(String urlSuffix, String uuid, String data, int connectTimeoutMs, int readTimeoutMs, boolean autoReport) throws KnowException {
